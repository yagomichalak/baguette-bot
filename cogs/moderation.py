...
class Moderation(commands.Cog):
	...
	async def user(self, ctx, member: discord.Member = None):
		...
		embed.add_field(name="Created at:", value=member.created_at.strftime("%d/%m/%y %I:%M %p GMT"),
						inline=False)
		embed.add_field(name="Joined at:", value=member.joined_at.strftime("%d/%m/%y %I:%M %p GMT"), inline=False)
